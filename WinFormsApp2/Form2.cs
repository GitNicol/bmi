        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (bmis < 18.5)
                {
                    ...
                    remarks = "Underweight";
                    guna2PictureBox3.Image = Resources.bmi__2_;
                }
                else if (bmis >= 18.5 && bmis <= 24.9)
                {
                    lblRemarks.Text = "Normal";
                    remarks = "Normal";
                    guna2PictureBox3.Image = Resources.bmi__3_;
                }
                else if (bmis >= 25 && bmis <= 29.5)
                {
                    lblRemarks.Text = "Overweight";
                    remarks = "Overweight";
                    guna2PictureBox3.Image = Resources.bmi__4_;
                }
                else if (bmis > 30)
                {
                    lblRemarks.Text = "Obese";
                    guna2PictureBox3.Image = Resources.bmi__5_;
                }
